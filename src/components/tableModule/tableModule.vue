<template>
    <div class="tableModule">
        ...
        <Page :total="object.count" size="small" show-elevator show-sizer style="float:right;margin:15px 20px;" @on-change="changePage"
            @on-page-size-change="changeSize" :page-size-opts="object.pageSizeOpts?object.pageSizeOpts:[10,20,30,40]" :page-size="object.pageSizeOpts?5:10"
...
<style lang="scss">
    ...
    .ivu-table td.status-column-blue-new{
        background-color: #336699;
        color: #fff;
        font-weight:bold;
    }
    .ivu-table td.status-column-yellow{
