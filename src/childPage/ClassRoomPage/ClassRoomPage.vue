...
<template>
  <div class="ClassRoomPage">
    ...
    <tableModule
      ...
      @addClassRoom="addClassRoom=true;$refs['addClassRoomForm'].resetFields();"
    ></tableModule>
    <Modal v-model="addClassRoom" title="添加课堂" width="800px" :mask-closable="false">
      <Form
        ...
        <Row>
          <Col span="12">
            <FormItem label="课程编号" class="forms" prop="CourseCode">
              <Input
                v-model="addClassRoomForm.CourseCode"
                disabled
                style="width:180px;"
                placeholder="请选择课程"
              ></Input>
          ...
          <Col span="12">
            <FormItem label="上课起始日期" class="forms" prop="BeginDate">
              <DatePicker
                ...
                placeholder="请选择起始日期"
                style="width: 265px"
                v-model="addClassRoomForm.BeginDate"
              ></DatePicker>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="上课截止日期" class="forms" prop="EndDate">
              <DatePicker
                ...
                placeholder="请选择截止日期"
                style="width: 265px"
                v-model="addClassRoomForm.EndDate"
              ></DatePicker>
            </FormItem>
          </Col>
          ...
          <Col span="12">
            <FormItem label="平时成绩权重" class="forms" prop="dailyPerformanceWeight">
              <InputNumber
                ...
                :max="1"
                style="width: 100%"
                v-model="addClassRoomForm.dailyPerformanceWeight"
              ></InputNumber>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="考试成绩权重" class="forms" prop="TestPerformaceWeight">
              <InputNumber
                ...
                :max="1"
                style="width: 100%"
                v-model="addClassRoomForm.TestPerformaceWeight"
              ></InputNumber>
            </FormItem>
          </Col>
        </Row>
    ...
    <Modal v-model="editClassRoom" title="编辑课堂" width="800px" :mask-closable="false">
      <Form
      ...
      >
        <Row>
          <Col span="12">
            <FormItem label="课程编号" class="forms" prop="CourseCode">
              <Input
                v-model="editClassRoomForm.CourseCode"
                disabled
                style="width:180px;"
                placeholder="请选择课程"
              ></Input>
          ...
          <Col span="12">
            <FormItem label="上课起始日期" class="forms" prop="BeginDate">
              <DatePicker
                ...
                placeholder="请选择起始日期"
                style="width: 265px"
                v-model="editClassRoomForm.BeginDate"
              ></DatePicker>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="上课截止日期" class="forms" prop="EndDate">
              <DatePicker
                ...
                placeholder="请选择截止日期"
                style="width: 265px"
                v-model="editClassRoomForm.EndDate"
              ></DatePicker>
            </FormItem>
          </Col>
          ...
          <Col span="12">
            <FormItem label="平时成绩权重" class="forms" prop="dailyPerformanceWeight">
              <InputNumber
                ...
                :max="1"
                style="width: 100%"
                v-model="editClassRoomForm.dailyPerformanceWeight"
              ></InputNumber>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="考试成绩权重" class="forms" prop="TestPerformaceWeight">
              <InputNumber
                ...
                :max="1"
                style="width: 100%"
                v-model="editClassRoomForm.TestPerformaceWeight "
              ></InputNumber>
            </FormItem>
          </Col>
        </Row>
      ...
      <div slot="footer">
        ...
        <Button
          type="primary"
          size="large"
          @click="editClassRoomHandleSubmit('editClassRoomForm')"
        >确定</Button>
      </div>
    </Modal>
    <!-- 课堂内容 -->
    <Modal
      v-model="classRoomInfoVisible"
      title="课堂内容"
      width="1200px"
      :mask-closable="false"
      :footer-hide="true"
    ...
    <courseModal
      ...
      @submit="courseModalSubmit"
      @cancel="courseModalVisible=false"
    ></courseModal>
    <!-- 导入学生 -->
    <Modal
      v-model="importStudentVisible"
      title="导入学生"
      width="300px"
      :mask-closable="false"
      :footer-hide="true"
      ...
      <Row style="margin-bottom:20px;">
        <a
          ...
          style="color:white;display:inline-block;width:100px;
            height:35px;background-color:rgb(45,140,240);line-height:35px;text-align:center"
        >下载模板</a>
      </Row>
      <Row>
        <Col span="24">
          <Upload
            :action="uploadFile + nowClassRoomId"
            :headers="{Authorization:$store.state.token}"
            style="float: left; margin-right: 20px;"
            :show-upload-list="false"
            :on-success="handleImportStudentSuccess"
    ...
    >
      <div>
        <Row>
          ...
          <Col
            span="1"
            style="background-color:#E0E6F8;font-weight:bold;text-align:center;"
          >{{scoreCount}}</Col>
          <Col
            span="1"
            style="background-color:#E0E6F8;font-weight:bold;text-align:center;"
      ...
      <tableModule
        :object="studentWorkTableModule"
        @changePage="swChangePage"
        @changeSize="swChangeSize"
      ></tableModule>
    </Modal>
    <!-- 打分 -->
    <Modal v-model="StudentGrade" title="评分" width="600px" :mask-closable="false">
      <InputNumber
        :min="0"
        :max="100"
        :precision="0"
        style="width: 100%"
        v-model="editStudentWorkForm.Score"
      ></InputNumber>
    ...
    <!-- 提交作业 -->
    <Modal v-model="addStudentWorkDetail" title="提交作业" width="600px" :mask-closable="false">
      <Form
        :model="addStudentWorkDetailForm"
        label-position="left"
        :label-width="100"
        :rules="studentWorkDetailRules"
        ...
        <Row>
          <Col span="24">
            <FormItem label="作业" class="forms" prop="WorkPath">
              ...
              <div
                v-if="!addStudentWorkDetailForm.WorkPath"
                v-model="addStudentWorkDetailForm.WorkPath"
              >
          ...
          <Col span="12">
            <FormItem label="分数" class="forms" prop="StudentWorkScore">
              <InputNumber
                ...
                :precision="0"
                style="width: 100%"
                v-model="addStudentWorkDetailForm.StudentWorkScore"
              ></InputNumber>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="代码行数" class="forms" prop="CodeRowNumber">
              <InputNumber
                ...
                :precision="0"
                style="width: 100%"
                v-model="addStudentWorkDetailForm.CodeRowNumber"
              ></InputNumber>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="用例通过数" class="forms" prop="CasePassCount">
              <InputNumber
                ...
                :precision="0"
                style="width: 100%"
                v-model="addStudentWorkDetailForm.CasePassCount"
              ></InputNumber>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="圈复杂度" class="forms" prop="Complexity">
              <InputNumber
                ...
                style="width: 100%"
                :step="0.1"
                v-model="addStudentWorkDetailForm.Complexity"
              ></InputNumber>
            </FormItem>
          </Col>
          <Col span="24">
            <FormItem label="作业留言" class="forms" prop="StudentWorkMessage">
              <Input
                type="textarea"
                v-model="addStudentWorkDetailForm.StudentWorkMessage"
      ...
      <div slot="footer">
        ...
        <Button
          type="primary"
          size="large"
          @click="addStudentWorkDetailHandleSubmit('addStudentWorkDetailForm')"
        >确定</Button>
      </div>
    </Modal>
    <!-- 学生作业明细 -->
    <Modal
      v-model="studentWorkDetailVisible"
      title="学生作业明细"
      width="1000px"
      :mask-closable="false"
      :footer-hide="true"
    ...
    >
      <tableModule
        :object="studentWorkDetailTableModule"
        @changePage="swdChangePage"
        @changeSize="swdChangeSize"
      ></tableModule>
    </Modal>
    <!-- 课堂试卷 -->
    <Modal v-model="addTestPaper" title="添加试卷" width="700px" :mask-closable="false">
      <Form
        :model="addTestPaperForm"
        label-position="left"
        :label-width="100"
        ...
        <Row>
          ...
          <Col span="12">
            <FormItem label="试卷类型" class="forms" prop="TestPaperType">
              <Select
                v-model="addTestPaperForm.TestPaperType"
                :placeholder="'请选择试卷类型'"
                @on-change="testPaperTypeChange"
              >
                <Option
                  v-for="item in testPaperTypeArr"
                  :value="item.value"
                  :key="item.value"
                >{{item.name}}</Option>
              </Select>
          ...
          <Col span="12">
            <FormItem class="forms" prop="A">
              <div v-model="addTestPaperForm.A" style="height:64px;">
                <Card
                  class="paperCardDefault"
                  v-if="addTestPaperForm.A.length == 0"
                  @click.native="addPaperDetail(1,'addTestPaperForm',addTestPaperForm)"
                >
                  <div style="color:#A4A4A4">
                    <Icon type="plus"></Icon>A卷
                  </div>
                </Card>
                <Card
                  class="paperCardA"
                  v-else
                  @click.native="editPaperDetail(1,'addTestPaperForm',addTestPaperForm)"
                >
                  <div>A卷</div>
                </Card>
              </div>
    ...
    <Modal v-model="editTestPaper" title="编辑试卷" width="700px" :mask-closable="false">
      ...
      >
        <Row>
          ...
          <Col span="12">
            <FormItem label="试卷类型" class="forms" prop="TestPaperType">
              <Select
                v-model="editTestPaperForm.TestPaperType"
                :placeholder="'请选择试卷类型'"
                @on-change="testPaperTypeChange"
              >
                <Option
          ...
          <Col span="12">
            <FormItem class="forms" prop="A">
              <div v-model="editTestPaperForm.A" style="height:64px;">
                <Card
                  class="paperCardDefault"
                  v-if="editTestPaperForm.A.length == 0"
      ...
      <div slot="footer">
        ...
        <Button
          type="primary"
          size="large"
          @click="editTestPaperHandleSubmit('editTestPaperForm')"
        >确定</Button>
      </div>
    </Modal>
    <Modal
      ...
      <Tabs v-model="detailTabIndex">
        ...
        <TabPane v-if="detailTestPaperForm.status == 2" label="考试详情">
          <Row style="margin-bottom:10px;">
            <Col span="4">
              <a
                :href="downloadStudentTestPaperTemplateUrl"
                download="muban"
                style="color:white;display:inline-block;width:100px;
                  height:35px;background-color:rgb(45,140,240);line-height:35px;text-align:center"
              >下载导入模板</a>
            ...
            <Upload
              :action="uploadStudentTestPaperFile + detailTestPaperForm.Id"
              :headers="{Authorization:$store.state.token}"
              style="float: left; margin-right: 20px;"
              :show-upload-list="false"
    ...
    <!-- 试题 -->
    <Modal v-model="testPaperDetail" title="编辑试题" width="600px" :mask-closable="false">
      <Row style="margin-bottom:10px;">
        <Col span="24">
      ...
      <Form
        :model="testPaperDetailForm"
        label-position="left"
        :label-width="100"
        ref="testPaperDetailForm"
      >
        <div v-for="(item,index) in testPaperDetailForm.testPaperDetailList" :key="index">
          <Row
            style="margin-bottom:5px;background-color:#EFF5FB;height:35px;line-height:36px;vertical-align:middle;"
          >
            <Col
              span="12"
              style="font-size:14px;font-weight:bold;padding-left:10px;float:left;"
            >第{{NumberToChinese(item.DetailNumber)}}题</Col>
            <Col span="12">
              <Button
                type="error"
                style="float:right;height:30px;margin-top:3px;"
                @click="delTestPaperDetail(index)"
                v-if="nowEditTestPaperType == 1"
              >删除</Button>
              <Button
                type="info"
                style="float:right;height:30px;margin-top:3px;margin-right:5px;"
                @click="downTestPaperDetail(index)"
              >下移</Button>
              <Button
                type="success"
                style="float:right;height:30px;margin-top:3px;margin-right:5px;"
                @click="upTestPaperDetail(index)"
              >上移</Button>
            </Col>
          </Row>
          <Row>
            ...
            <Col span="8">
              ...
              >
                <InputNumber
                  :disabled="nowEditTestPaperType == 2"
                  :min="1"
                  :max="100"
                  :precision="0"
                  style="width: 100%"
          ...
          <Row v-for="(kitem,kindex) in item.KnowledgeList" :key="kindex">
            <Col span="12">
              ...
              >
                <Select
                  :disabled="nowEditTestPaperType == 2"
                  v-model="kitem.KnowledgeId"
                  :placeholder="'请选择知识点'"
                >
                  <Option
                    v-for="ckitem in courseKnowledgeList"
                    :value="ckitem.Id"
                    :key="ckitem.Id"
                  >{{ ckitem.Name }}</Option>
                </Select>
            ...
            <Col span="4">
              <Button
                type="error"
                @click="delTestPaperDetailKnowledge(index,kindex)"
                v-if="nowEditTestPaperType == 1 && kindex != 0"
              >删除</Button>
            </Col>
          </Row>
          <FormItem
          ...
          >
            <Row>
              <Col span="12">
                <Button
                  v-if="nowEditTestPaperType == 1"
                  v-model="item.KnowledgeList"
                  type="dashed"
                  @click="handleAddKnowledge(index)"
                  icon="android-add"
                >添加知识点</Button>
              </Col>
            </Row>
      ...
      <div slot="footer">
        ...
        <Button
          type="primary"
          size="large"
          @click="testPaperDetailHandleSubmit('testPaperDetailForm')"
        >确定</Button>
      </div>
    </Modal>
...
export default {
  computed: {
    ...
    uploadStudentTestPaperFile: function() {
      return (
        API.importStudentTestPaper + "?filesname=StudentTestPaper&testPaperId="
      );
    }
  },
  data: function() {
    ...
    return {
      ...
      testPaperTypeArr: [{ name: "A卷", value: 1 }, { name: "AB卷", value: 2 }],
      detailTabIndex: 0,
      detailTPDTabIndex: 0,
      ...
      testPaperDetailColumn: [
        {
          ...
          render: (h, params) => {
            return h("div", [
              "第" + this.NumberToChinese(params.row.detailNumber) + "题"
            ]);
          }
        },
      ...
      courseKnowledgeList: [],
      knowledgeRule: {
        validator: validateKnowledgeList,
        trigger: "change",
        type: "array"
      },
  ...
  mounted: function() {
    ...
    this.$store.commit("changeBreadCrumb", ["首页", "教学管理", "我的课堂"]);
  ...
  methods: {
    ...
    addClassRoomHandleSubmit: function(name) {
      ...
      console.log(
        this.addClassRoomForm.dailyPerformanceWeight +
          this.addClassRoomForm.TestPerformaceWeight
      );
      var result = this.$refs[name].validate(valid => {
        if (valid) {
          ...
          if (sum != 1) {
            this.$Message.error("知识点权重之和为1!");
          } else if (sum == 1) this.$Message.error("表单信息不正确!");
        }
      });
      return result;
    },
    ...
    editClassRoomHandleSubmit: async function(name) {
      ...
      if (result) {
        console.log(this);
        var sum =
          this.editClassRoomForm.dailyPerformanceWeight +
          this.editClassRoomForm.TestPerformaceWeight;
        if (sum != 1) {
          this.$Message.error("知识点权重之和为1!");
        } else {
    ...
    downloadTemplate: function() {
      var params = {};
      Http.getClassRoomStudentTemplate(params, {
    ...
    getDetailTestPaperDetailList: function(id) {
      ...
      Http.TestPaperDetailList(params).then(res => {
        ...
        if (res.statusCode == 1) {
          ...
          this.downloadStudentTestPaperTemplateUrl =
            API.getStudentTestPaperTemplate + "?testPaperId=" + id;
          ...
          for (let i = 0; i < this.studentTestPaperList.length; i++) {
            ...
            for (let k = 0; k < this.detailTestPaperForm.A.length; k++) {
              ...
              if (this.studentTestPaperList[i].detailType == 1) {
                this.studentTestPaperList[i][k + 1] =
                  this.studentTestPaperList[i][k + 1] +
                  "/" +
                  this.detailTestPaperForm.A[k].score;
              } else {
                this.studentTestPaperList[i][k + 1] =
                  this.studentTestPaperList[i][k + 1] +
                  "/" +
                  this.detailTestPaperForm.B[k].score;
              }
              console.log(this.detailTestPaperForm.A[k]);
              detailTotalScore =
                detailTotalScore + this.detailTestPaperForm.A[k].score;
            }
            this.studentTestPaperList[i].totalScore =
              this.studentTestPaperList[i].totalScore + "/" + detailTotalScore;
          }
        }
      });
    },
    ...
    addPaperDetail: function(type, formName, form) {
      ...
      if (type == 2) {
        if (this.addTestPaperForm.A.length == 0) {
          ...
          for (
            let i = 0;
            i < this.testPaperDetailForm.testPaperDetailList.length;
            i++
          ) {
      ...
      var result = this.$refs[name].validate(valid => {
        if (valid) {
          if (this.nowEditTestPaperType == 1) {
            this.nowForm.A = JSON.parse(
              JSON.stringify(this.testPaperDetailForm.testPaperDetailList)
            );
            this.nowForm.B = [];
          } else {
            this.nowForm.B = JSON.parse(
              JSON.stringify(this.testPaperDetailForm.testPaperDetailList)
            );
          }
    ...
    delTestPaperDetailKnowledge: function(index, kindex) {
      this.testPaperDetailForm.testPaperDetailList[index].KnowledgeList.splice(
        kindex,
        1
      );
    },
