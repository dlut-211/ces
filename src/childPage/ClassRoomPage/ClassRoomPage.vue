  ...
  <div class="ClassRoomPage">
      ...
      <Modal v-model="importStudentVisible" title="导入学生" width="300px" :mask-closable="false" :footer-hide="true">
        <Row style="margin-bottom:20px;">
          <a :href='url' download="muban" style="color:white;display:inline-block;width:100px;height:35px;background-color:rgb(45,140,240);line-height:35px;text-align:center">下载模板</a>
        </Row>
          <Row>
            <Col span="24">
      ...
      <Modal v-model="addTestPaper" title="添加试卷" width="700px" :mask-closable="false">
        <Form :model="addTestPaperForm" label-position="left" :label-width="100" :rules="testPaperRule" ref="addTestPaperForm">
          <Row>
            <Col span="12">
            ...
            <Col span="12">
              <FormItem class="forms" prop="a">
                <div v-model="addTestPaperForm.a" style="height:64px;">
                  ...
                  <!-- 编辑A卷 -->
                  <Card class="paperCardA" v-else @click.native="editPaperDetail(1, 'addTestPaperForm', this.addTestPaperForm.a)">
                    <div> A卷</div>
                  </Card>
                </div>
              </FormItem>
        ...
        <Form :model="editTestPaperForm" label-position="left" :label-width="100" :rules="testPaperRule" ref="editTestPaperForm">
          <Row>
            <Col span="12">
              <FormItem label="试卷名称" class="forms" prop="name">
